      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center">
            ...
            {/* 品牌名称 - 现代与传统融合的字体设计 */}
            <span
              className={cn('font-bold text-2xl', isScrolled ? 'text-gray-900' : 'text-gray-900')}
            >
              <span className="text-red-600">Tech</span>
              <span className="text-gray-800">Guide</span>
              <span className="text-sm font-medium ml-1 bg-red-100 text-red-800 px-2 py-0.5 rounded-md">
                in China
              </span>
            </span>
          </Link>

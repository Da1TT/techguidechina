...
export const exhibitions: Exhibition[] = [
  // Q1 2026
  {
    ...
    description:
      "The most influential professional exhibition in China's smart building sector, focusing on smart buildings, IoT, AI applications in urban management, and gathering leading enterprises and internationally renowned manufacturers.",
    highlights: [
  ...
  // Q2 2026
  {
    ...
    description:
      "The only national-level exhibition in China's big data sector, focusing on big data, cloud computing, artificial intelligence and other cutting-edge technologies. It is an important indicator of global big data development.",
    highlights: [
...

  {
    ...
    description:
      "One of China's largest software and information service industry events, focusing on software development, digital transformation, and AI applications, gathering top technology enterprises and development teams from home and abroad.",
    highlights: [
  ...
  // Q3 2026
  {
    ...
    description:
      'One of most influential top-level events globally in field of artificial intelligence, bringing together leading AI companies and top experts and scholars worldwide to showcase the most cutting-edge AI technologies and applications.',
    highlights: [
...

  {
    ...
    description:
      "Asia's most influential digital entertainment exhibition, covering games, animation, VR/AR, e-sports, and more, showcasing the latest applications of AI in digital entertainment field.",
    highlights: [
  ...
  // Q4 2026
  {
    ...
    location: 'China National Convention Center, Beijing',
    description:
      "One of Asia's largest and most influential information communication exhibitions, focusing on 5G, IoT, cloud computing, artificial intelligence and other cutting-edge technologies.",
    highlights: [
...

  {
    ...
    description:
      'The top global event in internet field, focusing on digital economy, artificial intelligence, cybersecurity and other cutting-edge topics, bringing together leading figures in global internet sector.',
    highlights: [
...

  {
    ...
    description:
      "The most influential professional exhibition in China's IoT sector, showcasing cutting-edge technologies and solutions such as IoT sensors, RFID, and smart hardware.",
    highlights: [
...

  {
    ...
    description:
      'A professional event focusing on AI industry development, showcasing full-industry chain technologies such as AI algorithms, AI chips, and AI applications, promoting AI industrialization and implementation.',
    highlights: [

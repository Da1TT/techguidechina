...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    description:
      "Explore Shanghai's iconic Bund and modern Pudong skyline, experiencing the blend of Eastern and Western cultures.",
  ...
  },
  {
    ...
    description:
      "Explore the 8th Wonder of the World - Terracotta Army, and cycle along China's best-preserved Ming Dynasty city wall.",
  ...
  },
  {
    ...
    description:
      'Visit the world-famous Giant Panda Breeding Research Base and taste authentic Sichuan cuisine.',
  ...
  },
  {
    ...
    description:
      "Admire Guilin's magnificent karst landscape and take a traditional bamboo raft ride along the Li River.",
  ...
  },
  {
    ...
    description:
      'Visit the magnificent Mutianyu section of the Great Wall of China, one of the best-preserved sections.',

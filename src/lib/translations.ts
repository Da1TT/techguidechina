...
const translations: Translations = {
  en: {
    ...
    hero: {
      ...
      subtitle:
        "Professional guidance for international visitors to China's leading IT and AI exhibitions, with additional tailored China tour services.",
      tours: 'China Tours',
    ...
    services: {
      ...
      description:
        'We provide all the support you need to make your visit to China memorable and successful',
      tourGuide: 'Professional Tour Guide',
      tourGuideDesc:
        'Expert guides with deep knowledge of Chinese history and culture across major cities in China',
    ...
    featuredTours: {
      ...
      historicalDesc:
        "Explore Beijing's iconic landmarks including the Forbidden City, Tiananmen Square, and Temple of Heaven",
      modernTitle: 'Shanghai Modern City Tour',
      modernDesc:
        'Experience contemporary Shanghai with visits to the Bund, Pudong Skyline, and vibrant shopping districts',
      gardensTitle: 'Hangzhou West Lake Tour',
      gardensDesc:
        "Visit the beautiful West Lake and historic temples in Hangzhou, the 'Paradise on Earth'",
    ...
    exhibitionServices: {
      ...
      description:
        "We help international businesses navigate China's major technology exhibitions with professional assistance",
      whyChooseUs: {
    ...
    testimonials: {
      ...
      testimonial1:
        'The tour guide was exceptional - knowledgeable, friendly, and professional. Made our trip to China truly memorable!',
      testimonial2:
        "Their exhibition support services were invaluable. We wouldn't have been able to navigate the show without them.",
      testimonial3:
        'From airport pickup to tour arrangements, everything was handled seamlessly. Highly recommended for business travelers.',
    },
    cta: {

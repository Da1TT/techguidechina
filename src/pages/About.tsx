    ...
    return (
        <div className="pt-24 pb-16 px-4">
            ...
            <motion.div
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">We are a professional services provider specializing in IT and AI exhibition support and customized Beijing tours for international visitors, founded by tech industry experts with deep knowledge of China's technology ecosystem.
                            </p>
            </motion.div>
            {}
            <motion.div
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-gray-600 mb-4">Founded by Bowen Zhang&nbsp;and Yue Guan, TechGuide in China was created to bridge the gap between China's thriving tech ecosystem and international visitors. Recognizing the growing interest in China's IT and AI innovations, our founders set out to provide specialized support services for international businesses and professionals attending tech exhibitions in China.</p>
                        ...
                        <p className="text-gray-600">Today, TechGuide in China has successfully served thousands of clients from around the world, helping them navigate China's complex tech landscape with confidence and ease. Our commitment to excellence and deep industry knowledge has made us a trusted partner for businesses looking to engage with China's tech ecosystem.
                                        </p>
                    </div>
                    ...
                    {founders.map((founder, index) => <motion.div
                        ...
                        <div className="p-8">
                            <div className="flex flex-col items-center mb-8">
                                <div
                                    className="w-48 h-48 rounded-full overflow-hidden shadow-lg mb-6 border-4 border-red-100">
                                    <img
                                        src={founder.image}
                                        alt={founder.name}
                            ...
                            <div className="flex flex-wrap justify-center gap-2">
                                {founder.expertise.map((skill, i) => <span
                                    key={i}
            ...
            <motion.div
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">The principles that guide everything we do
                                  </p>
                </div>
                <motion.div
                    initial="hidden"
                    ...
                    {coreValues.map((value, index) => <motion.div
                        key={index}
                        variants={fadeIn}
                ...
                <div className="bg-red-600 rounded-2xl p-8 md:p-12 text-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="text-center">
                            <div
                                className="w-16 h-16 bg-white text-red-600 rounded-full flex items-center justify-center mx-auto mb-6">

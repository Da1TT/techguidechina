...
export default function About() {
  ...
  return (
    <div className="pt-24 pb-16 px-4">
      ...
      >
        <span className="text-red-600 font-medium">About</span>
        <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4">About TechGuide in China</h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          We are a professional services provider specializing in IT and AI exhibition support and
          customized Beijing tours for international visitors, founded by tech industry experts with
          deep knowledge of China's technology ecosystem.
        </p>
      </motion.div>
      {}
      <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Founded by Bowen Zhang&nbsp;and Yue Guan, TechGuide in China was created to bridge the
              gap between China's thriving tech ecosystem and international visitors. Recognizing
              the growing interest in China's IT and AI innovations, our founders set out to provide
              specialized support services for international businesses and professionals attending
              tech exhibitions in China.
            </p>
            <p className="text-gray-600 mb-4">
              With a combined background in IT, semiconductor technology, and international
              business, our team brings unique insights and expertise to every client engagement. We
              understand the specific needs of tech professionals visiting China and have tailored
              our services to provide comprehensive support for both exhibition participation and
              cultural exploration.
            </p>
            <p className="text-gray-600">
              Today, TechGuide in China has successfully served thousands of clients from around the
              world, helping them navigate China's complex tech landscape with confidence and ease.
              Our commitment to excellence and deep industry knowledge has made us a trusted partner
              for businesses looking to engage with China's tech ecosystem.
            </p>
          </div>
        ...
        <div className="bg-red-600 rounded-2xl p-8 md:p-12 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p>
                Our team has deep knowledge of China's IT and AI sectors, providing valuable
                insights beyond basic translation.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white text-red-600 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <p>
                We build long-term relationships with our clients based on trust, reliability, and
            ...
            <div className="text-center">
              ...
              <p>
                Our deep understanding of Chinese business culture and local customs ensures smooth

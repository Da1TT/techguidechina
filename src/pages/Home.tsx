...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const sortedExhibitions = [...allExhibitions].sort(
      (a, b) => a.startDate.getTime() - b.startDate.getTime()
    );
    const currentDate = new Date();

    // Get future exhibitions (within 7 days past to future)
    const futureExhibitions = sortedExhibitions.filter(
      (ex) => (ex.startDate.getTime() - currentDate.getTime()) / (1000 * 3600 * 24) >= -7
    );
    ...
    <div className="font-sans">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center items-center text-center text-white px-4">
          ...
          >
            <span className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium">
              Trusted by 500+ International Exhibitors
            </span>
          </motion.div>
          <motion.h1
            initial={{ opacity: 0 }}
          ...
          >
            Your Expert Exhibition Guide in China
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Professional translation, logistics support, and business guidance for US & European
            companies attending China's leading IT & AI exhibitions. 24/7 English support.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <button
              ...
              className="bg-white hover:bg-gray-100 text-red-600 px-8 py-3 rounded-full font-medium transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Get Exhibition Service
            </button>
            <Link
              to="/exhibitions"
              className="bg-transparent border-2 border-white hover:bg-white/10 text-white px-8 py-3 rounded-full font-medium transition-all"
            >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4">
              Complete Support for Your Exhibition Visit
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Everything you need for a successful exhibition experience in China, from arrival to
              departure
            </p>
          </motion.div>
          <motion.div
          ...
          >
            <motion.div
              variants={fadeIn}
              className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow relative"
            >
              ...
              <p className="text-gray-600">
                Expert Chinese-English translation for meetings, negotiations, and exhibition
                materials.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-600">
                Meet and greet at airport with private vehicle transfer to your hotel or exhibition
                venue.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-600">
                Introductions to Chinese tech companies and potential business partners.
              </p>
            </motion.div>
            <motion.div
              variants={fadeIn}
            ...
            >
              ...
              <p className="text-gray-600">
                Premium hotel recommendations and booking assistance near exhibition venues.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            ...
            >
              <Link to="/exhibitions" className="text-red-600 font-medium flex items-center">
                View All Exhibitions <i className="fa-solid fa-arrow-right ml-2"></i>
              </Link>
            </motion.div>
          </div>
                  ...
                  <div className="md:w-3/4 p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-5">
                      {exhibition.highlights.map((highlight, idx) => (
                        <span
                          key={idx}
                          className="inline-flex items-center text-xs bg-red-100 text-red-700 px-3 py-1 rounded-full"
                        >
                    ...
                    <div className="flex flex-col sm:flex-row与其他 gap-3 md:justify-between md:items-center">
                      <div className="text-sm text-gray-500">
                        ...
                        <span>
                          Starts in{' '}
                          {Math.floor(
                            (exhibition.startDate.getTime() - new Date().getTime()) /
                              (1000 * 60 * 60 * 24)
                          )}{' '}
                          days
                        </span>
                      ...
                      <div className="flex gap-3">
                        <button
                          onClick={() => handleRegister(exhibition)}
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            variants={staggerContainer}
            className="grid grid-cols-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"
          >
            {featuredTours.map((tour) => (
              <motion.div
                key={tour.id}
                variants={fadeIn}
                className="group bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xlx transition-all"
              >
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              With deep expertise in China's tech industry and years of professional experience, our
              founders are dedicated to providing exceptional service.
            </p>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-gray-600 text-center max-w-lg">
                With many years of experience in the IT and internet industry, Bowen Zhang has extensive
                knowledge of China's technology companies and exhibitions across the country. His
                expertise ensures clients receive the most insightful guidance during their visit.
              </p>
            </motion.div>
            <motion.div
              initial="hidden"
            ...
            >
              ...
              <p className="text-gray-600 text-center max-w-lg">
                With extensive experience in Fortune 500 IT companies, Yoyo Guan brings deep
                expertise in chip and battery technology. Her technical background and understanding
                of China's tech ecosystem provide valuable insights for clients attending technology
                exhibitions.
              </p>
            </motion.div>
          </div>
          ...
          >
            <motion.div variants={fadeIn} className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 italic mb-6">
                "The exhibition support was exceptional - knowledgeable, professional, and tailored
                to our specific needs. Zhang Bowen's insights into China's tech industry were
                invaluable for our business expansion plans."
              </p>
            ...
            <motion.div variants={fadeIn} className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 italic mb-6">
                "Guan Yue's technical background made our visit to AI exhibition truly insightful.
                Her translation services were excellent, and customized tour of Beijing's tech hubs
            ...
            <motion.div variants={fadeIn} className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 italic mb-6">
                "From airport pickup to exhibition navigation and city tours, everything was handled
                seamlessly. The team's knowledge of both China's tech industry and cultural
                landmarks made our trip both productive and enjoyable."
              </p>
              <div className="flex items-center">
      ...
      <section className="py-20 px-4 bg-red-600 text-white">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Succeed at China's Top Exhibitions?
          </h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Get expert translation, logistics support, and business networking assistance for your
            next exhibition in China. We support US & European companies every step of the way.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => setShowBookingForm(true)}
              className="bg-white text-red-600 px-8 py-3 rounded-full font-medium transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
      ...
      {showBookingForm && !selectedExhibition && !selectedTour && (
        <BookingForm
          onClose={() => setShowBookingForm(false)}
          serviceType="exhibition"
          serviceName="Exhibition Service"
        />
      )}
    </div>
  );

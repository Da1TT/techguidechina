  ...
  const serviceFeatures: ServiceFeature[] = [
    {
      ...
      description:
        'Expert guides with deep knowledge of Chinese history, culture, and tech industry.',
      icon: 'fa-user-tie',
    },
    {
      id: 2,
      ...
      >
        {filteredTours.map((tour) => (
          ...
          >
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-5 line-clamp-3">{tour.description}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-600">
              Comfortable vehicles with professional drivers, ensuring seamless travel between
              attractions.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            ...
            <p className="text-gray-600">
              Knowledgeable guides with deep understanding of Beijing's history, culture and modern
              development.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            ...
            <p className="text-gray-600">
              Professional interpreters to ensure smooth communication during your entire Beijing
              experience.
            </p>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-2/3 mb-8 md:mb-0 md:pr-8">
            ...
            <p className="text-red-100 mb-6">
              Can't find exactly what you're looking for? Our expert team can create a personalized
              itinerary tailored to your interests, needs, and schedule across China. Our services
              include private car with driver, professional translation, and knowledgeable guides.
            </p>
            <Link
              to="/contact"
